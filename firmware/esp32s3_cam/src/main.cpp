...
// і перевірено це на собі: OV5640 на налаштуваннях OV2640 дав вертикальні
...
static const SensorProfile PROFILES[] = {
  {OV2640_PID, "OV2640", 20, FRAMESIZE_VGA, 12, 1, 1, false, 20, 20, false, 0, 0,
   "виміряно: VGA 29-34 fps, кадр 9-14 КБ"},
  {OV3660_PID, "OV3660", 20, FRAMESIZE_VGA, 12, 1, 0, false, 20, 20, false, 0, 0,
   "з прикладу Freenove, на цій платі не перевірено"},
...
// піднімались і OV2640, і OV5640 — читання PID іде по SCCB (по суті I2C),
